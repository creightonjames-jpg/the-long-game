        ...
        <div className={`bg-cream-50 rounded-xl border shadow-xl p-7 mt-8 ${escalated ? 'border-red-400 ring-2 ring-red-300/50' : 'border-cream-200'}`}>
          {!selected ? (
            <>
              ...
              <h2 className="font-display text-2xl font-bold text-club-800 mb-1">{scenario.title}</h2>
              {scenario.speaker && (
                <p className="text-sm italic text-club-900/50 mb-4">— {scenario.speaker}</p>
              )}
              <p className="text-club-900/80 leading-relaxed mb-7">
                {escalated && scenario.escalatedPrompt ? scenario.escalatedPrompt : scenario.prompt}
              </p>
            ...
            <>
              ...
              <div className="bg-cream-100 border-l-4 border-gold-500 rounded-r-lg p-5 mb-6">
                <p className="text-xs font-semibold uppercase tracking-wide text-gold-600 mb-2">Mentor's Note</p>
